            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-md-3">
                        ...
                        <input type="text" name="facebook_link" id="facebook_link" value="<?php if (isset($row->facebook_link)) echo $row->facebook_link; ?>" class="form-control" autofocus required>
                    </div>
                    <div class="col-md-3">
                        <label class="control-label" for="instagram_link"> Instagram Link</label>
                        <input type="text" name="instagram_link" id="instagram_link" value="<?php if (isset($row->instagram_link)) echo $row->instagram_link; ?>" class="form-control" autofocus required>
                    </div>
                    <div class="col-md-3">
                        <label class="control-label" for="youtube_link"> Youtube Link</label>
                        <input type="text" name="youtube_link" id="youtube_link" value="<?php if (isset($row->youtube_link)) echo $row->youtube_link; ?>" class="form-control" autofocus required>
                    </div>
                    <div class="col-md-3">
                        <label class="control-label" for="twitter_link"> Twitter Link</label>
                        <input type="text" name="twitter_link" id="twitter_link" value="<?php if (isset($row->twitter_link)) echo $row->twitter_link; ?>" class="form-control" autofocus required>
                    </div>
                </div>
                <div class="col-md-12">                
                    <hr class="hr-short">
