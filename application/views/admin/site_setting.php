        ...
        <div class="col-md-12">
            <div class="form-group">
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="col-md-12">
                            <label class="control-label" for="site_first_section_heading">Subscribe Heading<span class="symbol required">*</span></label>
                        ...
                        <div class="col-md-12">
                            <label class="control-label" for="site_footer_text">Field Heading<span class="symbol required">*</span></label>
                            <input type="text" name="site_footer_text" value="<?php if (isset($adminsite_setting->site_footer_text)) echo $adminsite_setting->site_footer_text; ?>"  class="form-control" required>
                        </div>
                    </div>
                </div>
            </div>
